...
```
СONSTANT MaxPoints value: 100
СONSTANT Heigh value: 480
СONSTANT Width value: 640
СONSTANT Lines value: 24
СONSTANT Columns value: 80
СONSTANT red value: 0
СONSTANT green value: 1
СONSTANT blue value: 2
СONSTANT highlited value: 3
СONSTANT Ident value: 0
СONSTANT IntNumber value: 1
СONSTANT RealNumber value: 2
######################
TYPE ITERABLE size: 2 bytes
TYPE INTEGER size: 2 bytes
TYPE REAL size: 4 bytes
TYPE CHAR size: 1 bytes
TYPE POINTER size: 4 bytes
TYPE Coords size: 4 bytes
TYPE CoordsVector size: 400 bytes
TYPE BaseColor size: 2 bytes
TYPE Color size: 2 bytes
TYPE GraphicScreen size: 614400 bytes
TYPE TextScreen size: 9600 bytes
TYPE Domain size: 2 bytes
TYPE Token size: 42 bytes
TYPE Year size: 2 bytes
TYPE List size: 46 bytes
```

# Вывод
Научился реализовывать семантический анализ, пусть для небольшого 
подмножества языка pascal, однако это было достаточно интересно.
Курс по компиляторам супер !